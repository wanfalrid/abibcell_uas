...
@section('title', $category->name . ' - AbibCell')
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    @else
        <div class="text-center py-12">
            ...
            <h3 class="text-lg font-semibold text-gray-900 mb-2">Tidak ada produk dalam kategori ini</h3>
            <p class="text-gray-600">Coba lihat kategori lain atau kembali ke halaman utama</p>
            <a href="{{ route('home') }}" class="mt-4 inline-block bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition duration-300">
                Kembali ke Beranda
            </a>
        </div>
    @endif
